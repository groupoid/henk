...
-export([unlist/1,list/1,cogetLine/0,copure/0,main/0,corec/0]).
-export([putLine/0,pure/0,rec/0,list/0,pred/0,plus/2,ret/1,unret/1,nat/0,error/0,ok/0,unprod/1,prod/1]).
-export([bool/1,unbool/1,pr1/0,pr2/0,'false'/0,'true'/0,'if'/0,ap/2,ap1/2]).
