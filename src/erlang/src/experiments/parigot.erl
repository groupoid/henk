...
-export([main/0, ap/2, ap1/2, 'if'/0, bool/0, true/0, false/0, bool/1, unbool/1,
         prod/0, prodid/0, mk/0, pr1/0, pr2/0, prod/1, unprod/1,
         ret/0, retid/0, ok/0, error/0, io/0, ret/1, unret/1,
         nat_/0, nat/0, zero/0, succ/0, nat/1, unnat/1, plus/2,
         list_/0, list/0, nil/0, cons/0, list/1, unlist/1,
         getLine/0, putLine/0, pure/0, ma/0, unnat1/1, nat1/0, nat2/0,
         zero1/0, succ1/0, one1/0, two1/0, three1/0, four1/0, pred1/0, nat1/1]).
